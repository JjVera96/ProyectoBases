...
<html>
<head>
	<title>eliminar Producto - Droguerias FERJO</title>
	<meta charset="utf-8">
...
<div id='Contenido'>
	...
	<section>
		...
		<form action="eliminarMedicamento.php" method="post">
			...
			<input type="number" name="codEmp" id="codEmp" min="0" placeholder="Codigo Producto" required>
...
<?php
	...
	if(isset($_POST["btnSubmit"])){
		if(isset($_POST["codEmp"])){
			...
			$consulta = "DELETE FROM drogas WHERE Codigo = $cod";
			$result = mysqli_query($conexion, $consulta);
			if(mysqli_affected_rows($conexion)){
				echo "<h1 id='Bien'>Producto Eliminado Correctamente</h1>";
			}else{
				echo "<h1 id='Error'>Producto Inexistente</h1>";
			}
		}
	}
?>
